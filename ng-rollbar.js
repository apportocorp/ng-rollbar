...
/**
 * @license ng-rollbar 2.26.2 (2023-07-08)
 * (c) 2018-2023 Apporto
 */

(function(angular){
  angular.module('apportocorp/ng-rollbar', []);

  angular.module('apportocorp/ng-rollbar').config(['$provide', function($provide) {
  ...
  angular.module('apportocorp/ng-rollbar').provider('Rollbar', function RollbarProvider() {
